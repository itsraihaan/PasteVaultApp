  ...
  const handleShare = (paste) => {
    ...
    if (navigator.share) {
      navigator
        .share(shareData)
        .then(() =>
          toast.success("Shared successfully!", { position: "top-right" })
        )
        .catch(() =>
            ...
            {filteredPastes.length > 0 ? (
              filteredPastes.map((paste) => (
                ...
                >
                  ...
                  {/* Actions */}
                  <div
                    className="actions-grid grid gap-2" // Custom responsive grid
                  >
                    ...
                    <button
                      className="p-2 bg-white border rounded-lg transition hover:bg-orange-50 hover:border-orange-500"
                      onClick={() => navigate(`/pastes/${paste?._id}`)} // Navigate to /pastes/:id
                    >
                      <Eye
